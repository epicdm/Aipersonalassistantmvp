          ...
          <>
            <div className="bg-amber-500/10 border border-amber-500/20 rounded-2xl p-4 text-left">
              ...
              <p className="text-amber-200/70 text-xs leading-relaxed">
                Business agents can&apos;t share a number — your customers need to reach <strong>you</strong> directly, not a shared BFF line. Connect your WhatsApp Business number to activate {agentName}.
              </p>
            </div>
            <a
              href="/number"
              className="flex items-center justify-center gap-3 w-full py-5 bg-[#1877F2] hover:bg-[#166FE5] text-white rounded-2xl font-bold text-xl shadow-2xl shadow-blue-500/30 transition-all hover:scale-105"
            >
