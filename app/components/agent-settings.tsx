          ...
          <div className="p-4 bg-gray-50 rounded-2xl border border-gray-100 space-y-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">How your agent handles actions like sending emails or creating events.</p>
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 mt-2">
              {([
                ...
                >
                  <p className={`text-xs font-bold ${(localConfig.approvalMode || "confirm") === mode.id ? "text-white" : "text-gray-900"}`}>
                    {mode.label}
                  </p>
                  <p className={`text-[10px] mt-0.5 ${(localConfig.approvalMode || "confirm") === mode.id ? "text-indigo-100" : "text-gray-400"}`}>
                    {mode.desc}
                  </p>
                </button>
              ))}
